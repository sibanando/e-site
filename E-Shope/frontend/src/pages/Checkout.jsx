...
import { MapPin, Phone, Mail, ShieldCheck, CheckCircle, Loader, Navigation } from 'lucide-react';
...
const Checkout = () => {
    ...
    const [step, setStep] = useState('form'); // form | qr | processing | success
    ...
    if (step === 'processing') {
        return (
            <div style={{ background: '#f1f3f6', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <div style={{ background: 'white', borderRadius: '2px', boxShadow: '0 2px 8px rgba(0,0,0,0.12)', padding: '40px', textAlign: 'center' }}>
                    ...
                    <p style={{ fontSize: '13px', color: '#888', marginTop: '8px' }}>Please wait, do not close this window</p>
                </div>
            </div>
        );
    }
                                        ...
                                        <div>
                                            {!qrData ? (
                                                ...
                                                <div style={{ textAlign: 'center' }}>
                                                    ...
                                                    <p style={{ fontSize: '12px', color: '#e65100', marginBottom: '16px' }}>⏱ QR valid for 10 minutes</p>
                                                    <button
                                                        onClick={handlePaymentDone}
                                                        style={{ padding: '10px 32px', fontWeight: 700, fontSize: '13px', borderRadius: '2px', background: '#388e3c', color: 'white', border: 'none', cursor: 'pointer' }}
                                                    >
